...
show_help() {
    ...
    echo ""
    echo "Commands:"
    echo -e "  ${GREEN}start, --start-all${NC}           Start all services (MongoDB, Backend, Frontend)"
    echo -e "  ${GREEN}stop, --stop-all${NC}             Stop all services"
    echo -e "  ${GREEN}restart, --restart-all${NC}       Restart all services"
    echo ""
    echo -e "  ${GREEN}--start-backend${NC}              Start backend only"
    echo -e "  ${GREEN}--start-frontend${NC}             Start frontend only"
    echo -e "  ${GREEN}--stop-backend${NC}               Stop backend only"
    echo -e "  ${GREEN}--stop-frontend${NC}              Stop frontend only"
    ...
    echo -e "  ${GREEN}./manage.sh restart${NC}          # Restart with automatic cleanup"
    echo ""
    echo "Logs:"
